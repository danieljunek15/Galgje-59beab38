...
if(isset($_GET["random"])&&$_GET["random"] == true) {   
    ...
    $randIndex = array_rand($wordlist); 
    $_POST["galgjeword"] = $wordlist[$randIndex];
...
if (isset($_POST["galgjeword"])) {
    ...
    $_SESSION["chosenWord"] = $galgjeword;
...
<?php
if($_SESSION['fout'] === 10){
    echo "je hebt verloren oof <br>";
    echo "Het woord was " . $_SESSION["chosenWord"];
}
?>
</h2>
